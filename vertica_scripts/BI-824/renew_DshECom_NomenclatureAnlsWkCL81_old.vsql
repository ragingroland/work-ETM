...
create local temp table n_wk81
...
where DataInfo >= (select max(DataInfo) from DataMart.DshECom_NomenclatureAnlsWkCL81)
...
from n_wk81
left join DataPrime.ECom_InactiveCL81Wk nm81 on nm81.DataInfo = n_wk81.DataInfo
    and nm81.Status = n_wk81.Status
    and nm81.Class81_Code = n_wk81.Class81_Code
...
delete from DataMart.DshECom_NomenclatureAnlsWkCL81
...
select purge_table('DataMart.DshECom_NomenclatureAnlsWkCL81');

-- вставка в витрину с расшивкой 81 на уровни
insert into DataMart.DshECom_NomenclatureAnlsWkCL81
select
    DataInfo,
...
select analyze_statistics('DataMart.DshECom_NomenclatureAnlsWkCL81');
